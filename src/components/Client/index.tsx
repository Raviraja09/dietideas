    ...
    <div className="p-10 pb-20 px-16 flex flex-col pt-20 gap-16">
      <div className="flex items-center justify-between gap-3 w-full">
        ...
        <div className="flex flex-row gap-3">
          <button
            onClick={() => router.push("/Client/1/card")}
            className={`${inter500.className} shadow bg-primary text-white rounded-lg text-md px-6 py-1`}
          >
            Client Card
          </button>
          <button
            className={`${inter500.className} shadow bg-success text-white rounded-lg text-md px-6 py-1`}
          >
            MEAL LOG
          </button>
        </div>
      ...
      <div className="flex flex-col px-8 rounded-xl w-full ">
        <div className="flex justify-between w-full">
          ...
          <div className="flex flex-col p-10 py-5 h-auto w-[450px] gap-4 rounded-lg bg-white">
            <p className={`${inter600.className} text-primary text-md`}>
              About Patient
            </p>
